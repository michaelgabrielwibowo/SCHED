...
def test_export_schedule_artifacts_writes_expected_files_and_manifest(tmp_path):
    ...
    assert manifest_json["manifest_schema"] == "schedule_run_manifest_v1"
    assert manifest_json["schedule_schema"] == "schedule_export_bundle_v1"
    assert manifest_json["audit_schema"] == "schedule_audit_v1"
    ...
    assert schedule_json["schedule_schema"] == "schedule_export_bundle_v1"
    ...
    assert violations_json["audit_schema"] == "schedule_audit_v1"
